        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Ponovno slanje aktivacijske poveznice</div>
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" method="POST" action="{{ url('/email-verification-resend/send') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <button type="submit" class="btn btn-primary">
                                        Pošalji aktivacijsku poveznicu
                                    </button>
                                </div>
                            </div>
                        </form>
